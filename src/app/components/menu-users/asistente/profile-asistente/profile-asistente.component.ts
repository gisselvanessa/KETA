...
@Component({
  selector: 'app-profile-asistente',
  templateUrl: './profile-asistente.component.html',
  styleUrls: ['./profile-asistente.component.css']
})
export class ProfileAsistenteComponent implements OnInit {
  idUsuario:any
  usuarioData:any={};
  local_data:any={};
  avatar_name:string=''
  ...
  updateDetail() {
    ...
    forkJoin([
      ...
      error => {
        // Error al hacer una de las solicitudes
