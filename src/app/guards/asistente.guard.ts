...
/**
 * Este guard se utiliza para proteger rutas que solo deben ser accesibles por usuarios con un rol específico, en este caso, 
 * un rol de asistente (idrol == 2). Cuando un usuario intenta acceder a una ruta protegida por AsistenteGuard, 
 * el guard verifica el rol del usuario y decide si se permite o deniega el acceso a la ruta. En este caso, 
 * si el usuario tiene un rol de asistente, se permite el acceso; de lo contrario, se deniega el acceso.
 * @param route 
 * @param state 
 * @returns 
 */
  async canActivate(
    ...
    state: RouterStateSnapshot): Promise<boolean>  {
      ...
      // Comprueba si el usuario tiene un rol de asistente (idrol == 2)
