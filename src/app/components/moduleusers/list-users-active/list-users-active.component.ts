...
@Component({
  selector: 'app-list-users-active',
  templateUrl: './list-users-active.component.html',
  styleUrls: ['./list-users-active.component.css']
})
export class ListUsersActiveComponent implements OnInit {
  ...
  async get_all_vusers() {
    ...
    this.listaUsuarios = await firstValueFrom(this.userservice.get_all_users_active())
    this.loading=false;
